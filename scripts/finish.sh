...
echo -e "\n"
echo -e "\n"
echo -e "Screen sessions:"
echo "------------------"
echo "To access the lighthouse screen, run 'screen -r lighthouse'"
echo "To access the siren screen, run 'screen -r siren'"
echo "To access the reth screen, run 'screen -r reth'"
